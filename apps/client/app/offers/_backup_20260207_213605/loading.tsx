...
export default function Loading() {
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-6xl space-y-6 px-4 py-8 pb-24 sm:pb-8">
        <div>
        ...
        <div className="flex flex-wrap gap-2">
          <span className="h-10 w-28 rounded-full border border-zinc-200 bg-white/70" />
          <span className="h-10 w-20 rounded-full border border-zinc-200 bg-white/70" />
          <span className="h-10 w-20 rounded-full border border-zinc-200 bg-white/70" />
          <span className="h-10 w-24 rounded-full border border-zinc-200 bg-white/70" />
          <span className="h-10 w-20 rounded-full border border-zinc-200 bg-white/70" />
        </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-zinc-200 bg-white/80 backdrop-blur sm:hidden">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-around px-4 py-3">
          <span className="text-sm font-semibold text-zinc-900">Ofertas</span>
          <span className="text-sm font-semibold text-zinc-600">Pedidos</span>
          <span className="text-sm font-semibold text-zinc-600">Cuenta</span>
        </div>
      </nav>
    </main>
  );
